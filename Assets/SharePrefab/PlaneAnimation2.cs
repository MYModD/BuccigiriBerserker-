...
public class PlaneAnimation2 : MonoBehaviour
{
    ...
    [Range(0, 30f)]
    public float flapsDegreeRange = 10f; // ƒtƒ‰ƒbƒv‚Ì‰ñ“]”ÍˆÍ
    [Range(0, 40f)]
    public float elevatorUpDownDegreeRange = 40f; // ¸~‘Ç‚Ìã‰º•ûŒü‚Ì‰ñ“]”ÍˆÍ
    [Range(0, 40f)]
    public float elevatorLeftRightDegreeRange = 30f; // ¸~‘Ç‚Ì¶‰E•ûŒü‚Ì‰ñ“]”ÍˆÍ

    [Header("‰Â“®”{—¦")]
    public float multiplyValue = 40f; // “ü—Í‚Ì”{—¦
    ...
    [Range(0, 1f)]
    public float lerpTFlaps = 0.01f; // ƒtƒ‰ƒbƒv‚Ì•âŠÔ‘¬“x
    [Range(0, 1f)]
    public float lerpTElevators = 0.54f; // ¸~‘Ç‚Ì•âŠÔ‘¬“x
    [Range(0, 1f)]
    public float lerpTRightLeftElevators = 0.5f; // ¸~‘Çi¶‰Ej‚Ì•âŠÔ‘¬“x
